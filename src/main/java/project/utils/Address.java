...
public class Address {
    ...
    public String getStringAddress() {
        return streetNumber + " " + streetName + ", " + postalCode + " " + cityName + " " + countryName + ", " + additionalInfos;
    }
    ...
    public boolean equals(Object o) {
        ...
        return streetNumber == address.streetNumber && postalCode == address.postalCode && streetName.equals(address.streetName) && cityName.equals(address.cityName) && countryName.equals(address.countryName) && additionalInfos.equals(address.additionalInfos);
    }
